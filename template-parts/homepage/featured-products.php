...
<div class="fmc_home_products spacing_2_1">
	<div class="fmc_container">
		...
		<div class="fmc_home_p_inner spacing_0_1">
		...
		<a class="fmc_btn_2" href="<?php the_permalink( woocommerce_get_page_id( 'shop' ) ); ?>"><span class="btn_text">View All</span><span class="btn_icon"><svg width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
